...
- `event_types: optional array of "api_key.created" or "api_key.updated" or "api_key.deleted" or 144 more`
  ...
  Return only events with a `type` in one of these values. For example, `project.created`. For all options, see the documentation for the [audit log object](organization/audit_logs/index.md).
