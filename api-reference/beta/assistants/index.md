  ...
  - `ThreadRunCreated object { data, event }`
    ...
    - `data: Run`
      ...
      - `assistant_id: string`
        ...
        The ID of the [assistant](index.md) used for execution of this run.
      ...
      - `instructions: string`
        ...
        The instructions that the [assistant](index.md) used for this run.
      ...
      - `model: string`
        ...
        The model that the [assistant](index.md) used for this run.
      ...
      - `tools: array of CodeInterpreterTool or FileSearchTool or FunctionTool`
        ...
        The list of tools that the [assistant](index.md) used for this run.
  ...
  - `ThreadRunStepCreated object { data, event }`
    ...
    - `data: RunStep`
      ...
      - `assistant_id: string`
        ...
        The ID of the [assistant](index.md) associated with the run step.
  ...
  - `ThreadMessageCreated object { data, event }`
    ...
    - `data: Message`
      ...
      - `assistant_id: string or null`
        ...
        If applicable, the ID of the [assistant](index.md) that authored this message.
