...
- `data: array of RunStep`
  ...
  - `run_id: string`
    ...
    The ID of the [run](runs/index.md) that this run step is a part of.
        ...
        - `FunctionToolCall object { id, function, type }`
          ...
          - `function: object { arguments, name, output }`
            ...
            - `output: string or null`
              ...
              The output of the function. This will be `null` if the outputs have not been [submitted](runs/submit_tool_outputs.md) yet.
