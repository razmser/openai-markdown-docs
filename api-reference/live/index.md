...
- `ClientConfig object { data_channel }`
...
- `ClientEvent = SessionStartEvent or SessionUpdateEvent or InputAudioAppendEvent or 8 more`
  ...
  - `SessionStartEvent object { session, type, event_id }`
...
- `DataChannelConfig object { allowed_client_events, allowed_server_events }`
...
- `ResponsesDelegationConfig object { model, instructions, max_output_tokens, 6 more }`
...
- `ResponsesDelegationUpdateConfig object { instructions, max_output_tokens, model, 6 more }`
...
- `ServerEvent = SessionStartedEvent or SessionUpdatedEvent or InputAudioMutedEvent or 19 more`
...
- `ServerEventSelector object { type, response_event }`
...
- `SessionResource object { id, expires_at, model, 7 more }`
