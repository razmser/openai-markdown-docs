...
[text generation](https://developers.openai.com/docs/guides/text-generation), [vision](https://developers.openai.com/docs/guides/vision),
and [audio](https://developers.openai.com/docs/guides/audio) guides.

Parameter support can differ depending on the model used to generate the
response, particularly for newer reasoning models. Parameters that are only
supported for reasoning models are noted below. For the current state of
unsupported parameters in reasoning models,
[refer to the reasoning guide](https://developers.openai.com/docs/guides/reasoning).
...
- `messages: array of ChatCompletionMessageParam`
  ...
  [model](https://developers.openai.com/docs/models) you use, different message types (modalities) are
  supported, like [text](https://developers.openai.com/docs/guides/text-generation),
  [images](https://developers.openai.com/docs/guides/vision), and [audio](https://developers.openai.com/docs/guides/audio).
...
- `max_tokens: optional number or null`
  ...
  not compatible with [o-series models](https://developers.openai.com/docs/guides/reasoning).
...
- `modalities: optional array of "text" or "audio" or null`
  ...
  [generate audio](https://developers.openai.com/docs/guides/audio). To request that this model generate
...
- `store: optional boolean or null`
  ...
  use in our [model distillation](https://developers.openai.com/docs/guides/distillation) or
  [evals](https://developers.openai.com/docs/guides/evals) products.
...
- `stream: optional boolean or null`
  ...
  See the [Streaming section below](https://developers.openai.com/docs/api-reference/chat/streaming)
  for more information, along with the [streaming responses](https://developers.openai.com/docs/guides/streaming-responses)
...
- `tools: optional array of ChatCompletionTool`
  ...
  [custom tools](https://developers.openai.com/docs/guides/function-calling#custom-tools) or
  [function tools](https://developers.openai.com/docs/guides/function-calling).
...
- `web_search_options: optional object { search_context_size, user_location }`
  ...
  Learn more about the [web search tool](https://developers.openai.com/docs/guides/tools-web-search?api-mode=chat).
