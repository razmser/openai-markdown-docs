...
**NOTE:** Calling this endpoint requires an [admin API key](https://developers.openai.com/api/reference/resources/admin-api-keys).
...
**NOTE:** This endpoint requires an [admin API key](https://developers.openai.com/api/reference/resources/admin-api-keys).
...
[Learn more about fine-tuning](https://developers.openai.com/docs/guides/model-optimization)
...
- `model: string or "babbage-002" or "davinci-002" or "gpt-3.5-turbo" or "gpt-4o-mini"`
  ...
  [supported models](https://developers.openai.com/docs/guides/fine-tuning#which-models-can-be-fine-tuned).
